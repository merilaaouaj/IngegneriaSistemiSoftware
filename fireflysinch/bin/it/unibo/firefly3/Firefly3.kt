		...
		return { //this:ActionBasciFsm
				...
				state("flash") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t05",targetState="flash",cond=whenTimeout("local_tout_"+name+"_flash"))   
					transition(edgeName="t06",targetState="change",cond=whenEvent("timer"))
				}	 
				state("change") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("timer(T)"), Term.createTerm("timer(T)"), 
